...
(function injectPinyinGlyphFixStyle(){
  ...
  style.textContent =
    ...
    // Shifted up from the plain .py-acc's 0.38em: pixel-bbox probing showed
    // ü's own umlaut dots sit roughly 0.22em higher (above baseline) than a
    // plain vowel's ink-top, so the tone mark needs that same extra clearance
    // to land above the dots instead of stacking into them.
...
const I18N = {
  ...
  'nav.geography': '地理', 'nav.history': '历史',
  'learn.lessons': '课程',
